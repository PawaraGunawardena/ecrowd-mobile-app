...
public class LoginWrongCredentialsTest {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_username_login),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Helan"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editText_password_login),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("helan"), closeSoftKeyboard());
